...
def main():
    ...
    try:
        ...
        print("Installing uv...")
        if not run_command("curl -LsSf https://astral.sh/uv/install.sh | sh", "Install uv"):
    ...
    print(
        "2. Run: python main.py --financial-institution ipay --feature rename-file --statements-folder statements/adp-ipay"
    )
